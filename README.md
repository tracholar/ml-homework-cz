...
4. [基本梯度优化](basic-optimization/) [中等]
5. [深度学习CTR预估模型](deep-ctr/) [较难]
6. [分布式逻辑回归-参数服务器](distribute-lr/) [中等]
7. [强化学习-动态规划](/rl-dynamic-programming/) [容易]
8. [强化学习-时间差分](/rl-mc-td-learning/) [容易]
